...
- Full font licence: [LICENSE](LICENSE), also retained in the subset's original font metadata.

The outlines are bundled with the game; rendering the letters requires no network or browser font download.
