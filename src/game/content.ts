...
export const LANDMARKS: Landmark[] = [
  ...
  { id: 'enhancement', entrance: { x: 100, y: 1.05, z: -154.617, yaw: .575 }, name: 'Materialized Enhancements', artifact: 'Voronoi hill · design your character', x: 82, z: -178, color: '#b95f3d', stretch: { x: 5, z: 4.5 }, description: 'Behind the mycelium grove, an original Voronoi crystal grows into a faceted hill. Follow marked facets or walk through the lit cave and internal ramp to a human monument with a Voronoi chest. The base panel invites you to create your own character at enhancement.bio.' },
];
...
export const DISCOVERIES: Discovery[] = [
  { id: 'materialized-enhancements', landmark: 'enhancement', title: 'Materialized Enhancements', category: 'BIOART / PARTICIPATE', body: 'Materialized Enhancements combines a character-building game, a gene evidence knowledgebase, and printable bioart. Explore gene choices and their evidence levels, then generate a Voronoi crystal from your character. The hill preserves the supplied Voronoi STL, including its holes and angular cells, enlarged into a reddish landscape. Amber arrows mark an outside climb. A lit cave leads to a compact internal ramp and one summit exit. An outstretched human figure carries a miniature Voronoi form in its chest. Read the small base panel to join the project. Join the project to create your own character and crystal.', links: [{ label: 'Join here — create your character', url: 'https://enhancement.bio/' }] },
