...
export const LANDMARKS: Landmark[] = [
  ...
  { id: 'living-waters', entrance: { x: GARDENS.x + GARDENS.pavilionX, y: 1.05, z: GARDENS.pavilionZ - 9, yaw: Math.PI }, zone: 'gardens', name: 'Vittoria Lake', artifact: 'Living Waters · by train', x: GARDENS.x - 10, z: 0, color: '#81bcc0', stretch: { x: 6, z: 6 }, description: 'Board the Embryo Station train to visit Living Waters. Walk a branching silver network between shallow water eyes and enter an aquamarine pavilion inspired by Vittoria Amazonica and Dewdrop. The return train waits at the garden stop.' },
  { id: 'mycelium-garden', entrance: { x: GARDENS.x + 74, y: 1.05, z: -25, yaw: -2 }, zone: 'gardens', name: 'Mycelium Rain Garden', artifact: 'Folded crowns · by train', x: GARDENS.x + 75, z: 0, color: '#81a791', stretch: { x: 3, z: 4 }, description: 'At Living Waters, follow the eastern path into umbrella-like planting inspired by the Mycelium ring. Folded crowns collect rain above a dry loop; a visible silver rill links the opalescent basin to Vittoria Lake.' },
];
...
export const DISCOVERIES: Discovery[] = [
  ...RESEARCH_POSTERS,
  { id: 'living-vittoria', landmark: 'living-waters', title: 'Vittoria’s water eyes', category: 'LIVING WATERS / LIVISTONE INTERPRETATION', body: 'Livia’s Vittoria Amazonica pendant is silver and aquamarine, made in 2022. Here, its broad lily-pad form and branching openwork become a shallow landscape of water eyes and walkable silver nerves. The lake, train service and garden ecology are new Livistone fiction. Several paths lead around the cells to the blue pavilion; the shallow water is safe to walk through.', links: [{ label: 'Vittoria and the Survival collection', url: 'https://livia.glucosedao.org/pieces/' }] },
  ...
  { id: 'living-mycelium', landmark: 'mycelium-garden', title: 'A crown that lets water go', category: 'MYCELIUM / MATERIAL STORY', body: 'Livia describes designing Mycelium’s folded silver setting so water could drain away from its porous opal. Mushrooms and fungi informed the solution. Livistone enlarges that idea into umbrella-like plants and visible drainage rills. The garden is an imagined landscape, not a claim about ecological or medical performance. Follow the dry loop back to the platform whenever you are ready to return.', links: [{ label: 'Mycelium in the artist’s catalogue', url: 'https://livia.glucosedao.org/pieces/' }] },
