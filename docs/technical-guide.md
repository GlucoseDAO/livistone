# Livistone technical guide

For visitor instructions and setup, see [the README](../README.md). For publishing, see [production deployment](deployment.md).

A welcoming art-and-science fantasy town inspired by Livia Lore and Livia Zaharia's jewelry. Ten landmarks share one walkable town: leave Embryo Station facing the Livistone bridge, explore the civic gardens and Glucose Commons, climb Timeface Tower, then continue north into Vittoria Lake, Future House and the Mycelium grove. The town has one station, with its train and both railway lines together on the southern bank.

**Timeface Tower** has a round plaza, a guarded spiral walk and a summit terrace. Six panels combine Timeface with five older works not exhibited elsewhere. **Future House**, inspired by Camel Dalí, stands on Vittoria Lake's west bank: enter through the lowered head, climb the neck, and explore three works inside a leather-bound printed cabin with a curved hull and liquid copper legs. The rooftop name glows at night. Both destinations are available from the map.

The train's science/art advertisements use bold transit graphics and open the corresponding websites. Glucose chapters include ten full original presentation slides as well as research-poster extracts. Sculptural water plants borrow elliptical strips from Untold and triangular folds from A Sky for All. Night mode has a cratered moon and fine stars. [Extension references](../docs/extension-references.md) document the sources and architectural inventions.
...
**Glucose Commons** sits on the eastern civic garden path at `(38, -40)`. Walk beneath ribbons traced from a human insulin structure, inspect a separate glucose model, and open six chapter posters: why glucose matters, how it is measured, GlucoseDAO, Sugar-Sugar, forecasting research, and the insulin sculpture. Click/tap a poster or press E to step through images and text from the [supplied Drive folder](https://drive.google.com/drive/folders/1yRQlA4vkeTHwVFzbLx2WphQGPMnaMutV), including direct extracts from Livia’s Romanian AI Days 2026 poster. Open any source image at full size from its chapter; [image provenance](../public/images/research/ATTRIBUTION.md) records the originals. Jewelry halls show each work’s artist or exhibition story as well as materials. First-person start and Embryo Station arrivals look toward the city gate. Molecular source records are documented in [data/molecules/README.md](../data/molecules/README.md).
...
Use a current browser with WebGL 2 and hardware acceleration enabled. The loading introduction explains Livia’s architecture, jewellery, science and live kalimba recordings, with progress through town preparation. When ready, the town opens in first person at Embryo Station’s exit, facing the city gate. The introduction poster to the right of the bridge approach opens a readable journal story. The nearby-piece panel offers one sentence about the artwork you pass and a **Read story** button. The desktop **E** hint is also clickable; keyboard E uses the focused display or nearby story. Choose **Map** for the aerial view and **Resume exploring** to return to walking. Click any map label or place in the list to arrive outside its entrance; the station arrival also faces the gate. The **First person / Map** button in the top bar (or **M**) switches views without moving you. Fonts load from Google Fonts, with local fallbacks if they are unavailable.
...
| Switch aerial / first-person view | M or First person / Map | Labeled First person / Map button |
...
**Rendering.** Three.js with `WebGLRenderer` on WebGL 2, a skybox with matching reflections, and a directional light with shadows. Auto uses the visitor’s local clock; the menu can force Day or Night regardless of the clock. Each sky and its reflection map are baked once on first use and cached, with smaller cubemaps on mobile; GPS is not requested. Night adds actual lights at path fixtures and buildings, diffuse gemstone halos, a neon-like gate and luminous glucose and opals. A pool of six nearby point lights on reduced graphics or ten on rich graphics limits lighting cost. Vittoria Lake stays subdued around its lit briolette pavilion. The sky needs no remote assets. Walking uses a nearer distance haze and only draws nearby vegetation at full leaf detail; farther trees keep thinner foliage and then drop out in the fog. The aerial map keeps a longer haze and shows trunks rather than every leaf card. WebGPU is a later evaluation, not a current dependency.
...
**Embryo Station.** The station now stands on the southern arrival bank, with its ring exit aligned to the bridge and LIVISTONE gateway. It is adapted from the approved [Embryo concept](../concepts/06-town-extension/images/01-embryo-station.png). Walk through a deep silver ring band and glazed foyer beneath a thick, lobed amber body held by rounded silver clasps and branching columns. The ring has narrow polished rims and irregular leaf- and triangle-shaped openings through its curved sides, matching the jewelry photograph. The resin has a glossy refractive surface, fine internal markings, and a recessed core; the entrance has warm light strips and a shallow upper gallery. Trees frame the approach so the ring is visible from the gardens. Benches, station signs, a tactile platform edge, and a parked streamlined ultra-fast train establish the arrival space. Platform screens separate the concourse from the railway except at the two aligned boarding gates. Find **Embryo Station** on the aerial map; discover its story at the panel beside the entrance. Two open gates and gently sloping boarding bridges lead into the parked maglev’s walkable passenger cabin, with transparent panoramic windows, rounded upholstered lounge seats, a carpeted aisle, and continuous ceiling lighting. Inside the cabin, “Step into the future” boards and double-triangle announcements point one way to science and the opposite way to art and geometry; click or press E to open [Livia’s public catalogue](https://livia.glucosedao.org/pieces/). The train stays parked here; the lake and mushroom grove are reached along the town’s walking paths. Mobile uses simpler amber and silver geometry, with opaque golden resin instead of refraction.

**Jewelry exhibitions.** Permanent, flat photo posters occupy the interior perimeters: eight works in City Hall, eight in Energy, nine in Science, and seven in the station. Captions and the lore dialog include the artist or exhibition story as well as materials. Stories come from [Livia’s public catalogue](https://livia.glucosedao.org/pieces/) and the official Romanian Jewelry Week designer pages; missing Facebook/Instagram post bodies were not invented. Every work has one physical home. A 35-work journal catalogue includes three additional archive pieces. Source-reviewed facts, photograph paths and source hashes are kept in [the catalogue manifest](../data/catalogue/README.md).
...
**Water rendering.** The surface uses the baked sky reflection environment, moving ripple normals, muted green water, shallow-edge colour variation, irregular bank widths, and narrow gravel shores. This is a lightweight visual water shader, not fluid simulation or a live planar reflection pass.
...
- Walk across an arched stone river bridge into leafy gardens, under a cloudy daylight sky or a manually selected or clock-based night sky, with clear paved approaches to the jewelry-inspired civic buildings.
...
- Leave southern Embryo Station facing the bridge, or turn back through its silver ring to explore the concourse, train platform, and cabin announcements for science versus art.
...
- Walk beneath human insulin at Glucose Commons and open six GlucoseDAO chapter posters with original poster images and text from the supplied Drive folder.
- Walk north into Living Waters, read the Vittoria and Dewdrop stands, and explore the silver Mycelium grove with tall crowns and lower ring-scale shrubs. Follow the paths back to the civic gardens.
...
**Ground cover.** `ground-cover.ts` indexes path segments once and bakes soil weights and broad spring-green colour variation into the existing mountain vertices. `mountains.ts` blends local meadow/soil WebP maps, using two texture samples on flat ground and retaining rock detail on slopes. No extra mesh, draw call or per-frame CPU update is added. Reduced detail loads 512 px derivatives (about 130 KiB total) and omits the rock normal texture; rich detail loads 1024 px derivatives (about 536 KiB total). `python3 scripts/build-ground-textures.py` regenerates the CC0 Poly Haven derivatives and source hashes. Terrain collision follows the shared height field and tunnel clipping is preserved; clipped vertices interpolate the soil attribute too.
